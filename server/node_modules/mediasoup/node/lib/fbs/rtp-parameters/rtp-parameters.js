...
class RtpParameters {
    ...
    static addMsid(builder, msidOffset) {
        builder.addFieldOffset(5, msidOffset, 0);
    }
    ...
    unpack() {
        return new RtpParametersT(this.mid(), this.bb.createObjList(this.codecs.bind(this), this.codecsLength()), this.bb.createObjList(this.headerExtensions.bind(this), this.headerExtensionsLength()), this.bb.createObjList(this.encodings.bind(this), this.encodingsLength()), (this.rtcp() !== null ? this.rtcp().unpack() : null), this.msid());
    }
    unpackTo(_o) {
        _o.mid = this.mid();
...
class RtpParametersT {
    ...
    rtcp;
    msid;
    constructor(mid = null, codecs = [], headerExtensions = [], encodings = [], rtcp = null, msid = null) {
        this.mid = mid;
        this.codecs = codecs;
    ...
    pack(builder) {
        ...
        const msid = (this.msid !== null ? builder.createString(this.msid) : 0);
        ...
        RtpParameters.addMsid(builder, msid);
