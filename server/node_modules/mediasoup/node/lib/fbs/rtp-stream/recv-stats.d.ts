...
export declare class RecvStats implements flatbuffers.IUnpackableObject<RecvStatsT> {
    ...
    static createRecvStats(builder: flatbuffers.Builder, baseOffset: flatbuffers.Offset, packetCount: bigint, byteCount: bigint, bitrate: number, bitrateByLayerOffset: flatbuffers.Offset): flatbuffers.Offset;
    unpack(): RecvStatsT;
...
export declare class RecvStatsT implements flatbuffers.IGeneratedObject {
    ...
    constructor(base?: StatsT | null, packetCount?: bigint, byteCount?: bigint, bitrate?: number, bitrateByLayer?: (BitrateByLayerT)[]);
