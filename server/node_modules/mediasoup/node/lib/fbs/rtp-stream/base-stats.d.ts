...
export declare class BaseStatsT implements flatbuffers.IGeneratedObject {
    ...
    roundTripTime: number;
    score: number;
    constructor(timestamp?: bigint, ssrc?: number, kind?: MediaKind, mimeType?: string | Uint8Array | null, packetsLost?: number, fractionLost?: number, jitter?: number, packetsDiscarded?: bigint, packetsRetransmitted?: bigint, packetsRepaired?: bigint, nackCount?: bigint, nackPacketCount?: bigint, pliCount?: bigint, firCount?: bigint, rid?: string | Uint8Array | null, rtxSsrc?: number | null, rtxPacketsDiscarded?: bigint, roundTripTime?: number, score?: number);
