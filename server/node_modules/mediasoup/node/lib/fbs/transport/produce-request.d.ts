...
export declare class ProduceRequest implements flatbuffers.IUnpackableObject<ProduceRequestT> {
    ...
    static addEnableMediasoupPacketIdHeaderExtension(builder: flatbuffers.Builder, enableMediasoupPacketIdHeaderExtension: boolean): void;
...
export declare class ProduceRequestT implements flatbuffers.IGeneratedObject {
    ...
    keyFrameRequestDelay: number;
    enableMediasoupPacketIdHeaderExtension: boolean;
    constructor(producerId?: string | Uint8Array | null, kind?: MediaKind, rtpParameters?: RtpParametersT | null, rtpMapping?: RtpMappingT | null, paused?: boolean, keyFrameRequestDelay?: number, enableMediasoupPacketIdHeaderExtension?: boolean);
