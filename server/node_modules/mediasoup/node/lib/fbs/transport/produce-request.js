...
class ProduceRequest {
    ...
    static addKeyFrameRequestDelay(builder, keyFrameRequestDelay) {
        builder.addFieldInt32(5, keyFrameRequestDelay, 0);
    }
    static addEnableMediasoupPacketIdHeaderExtension(builder, enableMediasoupPacketIdHeaderExtension) {
        builder.addFieldInt8(6, +enableMediasoupPacketIdHeaderExtension, +false);
    }
    ...
    unpack() {
        return new ProduceRequestT(this.producerId(), this.kind(), (this.rtpParameters() !== null ? this.rtpParameters().unpack() : null), (this.rtpMapping() !== null ? this.rtpMapping().unpack() : null), this.paused(), this.keyFrameRequestDelay(), this.enableMediasoupPacketIdHeaderExtension());
    }
    unpackTo(_o) {
        ...
        _o.enableMediasoupPacketIdHeaderExtension = this.enableMediasoupPacketIdHeaderExtension();
    }
}
...
class ProduceRequestT {
    ...
    keyFrameRequestDelay;
    enableMediasoupPacketIdHeaderExtension;
    constructor(producerId = null, kind = media_kind_1.MediaKind.AUDIO, rtpParameters = null, rtpMapping = null, paused = false, keyFrameRequestDelay = 0, enableMediasoupPacketIdHeaderExtension = false) {
        ...
        this.enableMediasoupPacketIdHeaderExtension = enableMediasoupPacketIdHeaderExtension;
    }
    pack(builder) {
        ...
        ProduceRequest.addEnableMediasoupPacketIdHeaderExtension(builder, this.enableMediasoupPacketIdHeaderExtension);
